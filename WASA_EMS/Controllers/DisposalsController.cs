...
namespace WASA_EMS.Controllers
{
    public class DisposalsController : Controller
    {
        ...
        public PartialViewResult _WellsReportView(string resources, string datFrom, string timFrom, string datTo, string timTo)
        {
            ...
            scriptString += "{ type: \"area\", name: \"Tank 1\", showInLegend: true,  markerSize: 1, xValueType: \"dateTime\", xValueFormatString: \"HH:mm:ss DD-MM-YYYY\", yValueFormatString: \"#,##0.##\", toolTipContent: \"{label}<br/>{name}, <strong>{y} ft</strong> at {x}\", ";
            ...
            scriptString += "{ type: \"area\", name: \"Tank 2\", showInLegend: true,  markerSize: 1, xValueType: \"dateTime\", xValueFormatString: \"HH:mm:ss DD-MM-YYYY\", yValueFormatString: \"#,##0.##\", toolTipContent: \"{label}<br/>{name}, <strong>{y} ft</strong> at {x}\", ";
